    ...
    public abstract class AIPlayer : Player
    {
        ...
        protected class Location
        {
            ...
            public static bool operator ==(Location @this, Location other)
            {
                ...
                {
                    return object.ReferenceEquals(@this.Row, other.Row) && object.ReferenceEquals(@this.Column, other.Column);
                }
            ...
            public static bool operator !=(Location @this, Location other)
            {
                ...
                return object.ReferenceEquals(@this, null) || object.ReferenceEquals(other, null);
            }
        }
